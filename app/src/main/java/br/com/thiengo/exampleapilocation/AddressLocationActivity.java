...
import br.com.thiengo.exampleapilocation.domain.MessageEB;
import br.com.thiengo.exampleapilocation.service.LocationIntentService;
    ...
    // LISTERNERS
        ...
        public void onEvent(final MessageEB m){
            runOnUiThread(new Runnable(){
                @Override
                public void run() {
                    if( m.getClassName().equalsIgnoreCase( AddressLocationActivity.class.getName() ) ) {
